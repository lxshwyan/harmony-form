...
- 12 列响应式 span、light/dark 主题、无障碍外壳；
...
`verify-showcase.sh` 会清理依赖、重新安装当前 HAR、校验声明和 ABC 哈希，再构建 release HAP。设备脚本安装 `com.hmkit.form.showcase` 并验证推导字段/插槽、步骤错误摘要、FormArray、受控回填与主题切换。
